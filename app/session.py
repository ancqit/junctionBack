"""Guest sessions for junction.today (no user login). Default TTL 15 minutes."""
...
SESSION_EXPIRE_SECONDS = int(os.getenv("SESSION_EXPIRE_SECONDS", "900"))
...
def create_session(request: Request) -> SessionResponse:
    ...
    Returns session_id + JWT valid for SESSION_EXPIRE_SECONDS (default 900).
    """
