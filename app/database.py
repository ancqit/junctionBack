...
catalog_contacts = database["catalog_contacts"]
digilocker_states = database["digilocker_states"]
gst_sessions = database["gst_sessions"]
...
shop_viewer_day_logs = database["shop_viewer_day_logs"]
...
monster_posts = database["monster_posts"]
monster_profiles = database["monster_profiles"]
waste_archive = database["waste_archive"]
earth_growers = database["earth_growers"]
earth_apartments = database["earth_apartments"]
